...
train_bank_grid <- function(train_test_data) {
  ...
  print(paste("AUC de l'arbre de décision (paramètres par défaut) :", auc_value_dt))
  ...
  print(paste("AUC de la régression logistique (paramètres par défaut) :", auc_value_logistic))
  ...
  # 8. Grid search pour SVM avec le meilleur noyau
  #svm_poly <- grid_search_svm(train_data, test_data, y_train, y_test,'polynomial')
  
  # Afficher les meilleurs hyperparamètres et l'AUC
  #print(paste("Meilleur C :", svm_poly$C))
  #print(paste("Meilleur gamma :", svm_poly$gamma))
  #print(paste("Meilleure AUC :", svm_poly$auc))
